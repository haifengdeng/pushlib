...
struct SimpleOutput : BasicOutputHandler {
	...
	SimpleOutput(BroardcastBase* main_);
...
SimpleOutput::SimpleOutput(BroardcastBase* main_) :
...
struct AdvancedOutput : BasicOutputHandler {
	...
	AdvancedOutput(BroardcastBase* main_);
...
AdvancedOutput::AdvancedOutput(BroardcastBase* main_) :
                BasicOutputHandler(main_)
{
...
inline void AdvancedOutput::SetupStreaming()
{
	...
	const char *rescaleRes = config_get_string(config, "AdvOut",
			"RescaleRes");
	bool multitrack = config_get_bool(config, "AdvOut",
			"Multitrack");
	int trackIndex = config_get_int(config, "AdvOut",
			"TrackIndex");
	int trackCount = config_get_int(config, "AdvOut",
			"TrackCount");
	unsigned int cx = 0;
	unsigned int cy = 0;
...
{
	const char *name1 = config_get_string(config, "AdvOut",
			"Track1Name");
	const char *name2 = config_get_string(config, "AdvOut",
			"Track2Name");
	const char *name3 = config_get_string(config, "AdvOut",
			"Track3Name");
	const char *name4 = config_get_string(config, "AdvOut",
			"Track4Name");
	bool applyServiceSettings = config_get_bool(config, "AdvOut",
			"ApplyServiceSettings");
